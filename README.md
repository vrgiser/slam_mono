...
It will also build a binary `slam_mono`, to run DSO on datasets. However, for this
...
Per default, `slam_mono` writes all keyframe poses to a file `result.txt` at the end of a sequence,
